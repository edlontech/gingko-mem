defmodule Gingko.TestSupport.Mnemosyne.MockEmbedding do
  @moduledoc false
  ...
  def embed(_text, _opts \\ []) do
    {:ok, %Response{vectors: [List.duplicate(0.1, 128)], model: "mock:embed", usage: %{}}}
  end

  @impl true
  def embed_batch(texts, _opts \\ []) do
    vectors = Enum.map(texts, fn _ -> List.duplicate(0.1, 128) end)
    {:ok, %Response{vectors: vectors, model: "mock:embed", usage: %{}}}
  end
end
